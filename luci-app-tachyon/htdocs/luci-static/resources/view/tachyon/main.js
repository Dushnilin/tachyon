...
var TachyonShellMethods = {
  ...
  getSingBoxStatus: async () =>
    callBaseMethod(Tachyon.AvailableMethods.GET_SING_BOX_STATUS),
  getZapretStatus: async () =>
    callBaseMethod(Tachyon.AvailableMethods.GET_ZAPRET_STATUS),
  getZapret2Status: async () =>
    callBaseMethod(Tachyon.AvailableMethods.GET_ZAPRET2_STATUS),
  getByedpiStatus: async () =>
    callBaseMethod(Tachyon.AvailableMethods.GET_BYEDPI_STATUS),
