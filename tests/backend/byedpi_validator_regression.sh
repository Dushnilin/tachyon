...
VALIDATOR="$ROOT_DIR/podkop/files/usr/lib/providers/byedpi/validator.uc"
WORK_DIR="$(mktemp -d)"
...
ucode -L "$PODKOP_LIB" "$WORK_DIR/require-byedpi-validator.uc"

printf 'ByeDPI validator regression checks passed\n'
