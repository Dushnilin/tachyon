...
Проект объединяет в себе мощь **sing-box**, локальные средства обхода DPI (**Zapret v1 / Zapret v2 / ByeDPI**), интерактивного **Telegram-бота**, а также инновационный **2026 AI Stack** (автономный **AI Doctor** и **HTTP REST Agent API / OpenAPI 3.0**).
...
### 🤖 2. ИИ-Доктор и HTTP REST Agent API (2026 AI Stack)
